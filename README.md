...
<p align="center">
  ...
  <a href="https://andrelinosilva.com.br">
    <img alt="Made by Andrelino silva" src="https://img.shields.io/badge/made%20by-Andrelino%20Silva-%2304D361">
  </a>

  <img alt="License" src="https://img.shields.io/badge/license-MIT-%2304D361">

  <a href="https://github.com/andrelinos/bootcamp-gostack-desafios/stargazers">
    <img alt="Stargazers" src="https://img.shields.io/github/stars/andrelinos/bootcamp-gostack-desafios?style=social">
  </a>
</p>

<p align="center">
  <a href="#rocket-sobre-o-desafio">Sobre o desafio</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
  <a href="#arrowdown-como-baixar">Como baixar</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
  <a href="#running-como-executar">Como executar</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
...
- Execute o segunte comando
  ```zsh
  git clone git@github.com:andrelinos/gostack-fundamentos-reactjs.git
...
```
- Aguarde finalizar
- Assim que terminar, irá abrir no seu navegador

**Nota**: Você precisa estar executando o back-end para que a aplicação tenha acesso à api com os dados.

**Link do projeto back-end**: https://github.com/andrelinos/gostack-typeorm-upload
...
Feito com 💜 by Andrelino Silva

Acesse a comunidade da Rocketseat :wave: [Entre na nossa comunidade!](https://discordapp.com/invite/gCRAFhc)
